...
module.exports = class {
    ...
    started() {
        ...
        console.log(`\x1B[34m[${now}] [THINK] ====================================\x1B[39m`);
        think.app_debug && console.warn(`\x1B[33m[${now}] [THINK] Debugging mode is running, if the production environment, please modify the app_debug value to false\x1B[39m`);
    }
